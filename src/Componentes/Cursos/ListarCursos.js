...
import a from './a.png';
import TablaCursos from './TablaCursos.js';
    ...
    this.llenargrid=this.llenargrid.bind(this);
      this.onSelectChange=this.onSelectChange.bind(this);
         this.showmodal1=this.showmodal1.bind(this);
            ...
            this.showModalp=this.showModalp.bind(this);
            this.handleOkp=this.showModalp.bind(this);
            this.handleCancelp=this.handleCancelp.bind(this);
...
var show=(<Button onClick={this.editarNota.bind(this, xc)}>Editar</Button>);
...
var ver_modulos=(<Button onClick={this.showModalp}>Ver</Button>);
